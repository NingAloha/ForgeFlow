...
class RequirementsEngineerAgentTests(unittest.TestCase):
    ...
    def test_agent_consumes_answered_question_state(self) -> None:
        ...
        self.assertEqual(result.updated_state["project_goal"], "A workflow assistant for solo builders")
        self.assertIn("Collect requirements", result.updated_state["functional_requirements"])
        self.assertEqual(
